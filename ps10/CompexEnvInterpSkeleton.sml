(***************************************************************
 This is a copy of BindexEnvInterp.sml, which describes evaluation
 in the Bindex language. 

 Your goal is to modify this file to describe evaluation in the Compex language. 
 Compex extends Bindex with the following construct specified in the ps10 description: 
