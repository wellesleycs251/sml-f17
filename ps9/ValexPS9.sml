...
structure Valex = struct
  ...
  val primops = [ 
    ...
    (* Put your new primops from "PS9" Problem 5 here *)
  ...
  ************************************************************)
  ...
  and desugarRules sexp = 
	...
	(* Put your desugaring rules for the "PS9" Problem 6 classify construct here *)
	      
	(* Special case when don't match any rule *)
  ...
  ************************************************************)
  ...
  and freeVarsExps es = 
      List.foldr (fn (fvs, ans) => (S.union fvs ans))
		 S.empty
		 (List.map freeVarsExp es)
